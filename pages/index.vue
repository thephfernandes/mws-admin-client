<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      ...
      <v-card class="my-5" id="content-management-card">
      ...
      <v-card class="my-5" id="customers-card">
      ...
      <v-card class="my-5" id="orders-card">
      ...
      <v-card class="my-5" id="finance-card">
      ...
      <v-card class="my-5" id="matches-card">
